...
<table id="dg" title="博客管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
	...
	<thead>
		<tr>
			...
			<th field="title" width="200" align="center" formatter="formatTitle"></th>
			<th field="releaseDate" width="50" align="center">发布日期</th>
			<th field="blogType" width="50" align="center" formatter="formatBlogType"></th>
		</tr>
	</thead>
</table>
<div id="tb">
	...
	<div>
		...
		<a href="javascript:searchBlog()" class="easyui-linkbutton" plain="true" iconCls="icon-search"></a>
	</div>
</div>
</body>
</html>